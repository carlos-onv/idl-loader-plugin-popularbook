...
function idl_loader_parents_club_template_styles() {
    ...
    if ( $is_parents_page ) {
        ...
        wp_enqueue_style( 'parents-club-dashboard-subscription', plugins_url( 'templates/css/parents-club-dashboard-subscription.css', __FILE__ ), array(), '1.3.0' );
        wp_enqueue_style( 'parents-club-dashboard-coins', plugins_url( 'templates/css/parents-club-dashboard-coins.css', __FILE__ ), array(), '1.3.0' );
        wp_enqueue_style( 'parents-club-dashboard-billing', plugins_url( 'templates/css/parents-club-dashboard-billing.css', __FILE__ ), array(), '1.3.0' );
    }
}
