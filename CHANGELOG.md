...
- **Updated `#parents-club-member-quick-links` (`parents-club-member-quick-links.css`)**: Added `margin-bottom: 20px;`.
...
- **Bambora Custom Checkout Script Preservation (`functions.php`)**:
  ...
  - Updated `wc-country-select` script deregistration check at line 420 to use `!idl_loader_is_checkout_context()`, preserving checkout scripts on URLs with query parameters (e.g. `/shop-checkout?test-1`).
...
### Removed
- **`dynamic_top_5_best_seller_scroller_shortcode` & `homepage_best_seller_scroller`**:
  - Removed shortcode registration from [functions.php](file:///Users/carlos/Local%20Sites/dev-popularbook/app/public/wp-content/plugins/idl-loader/functions.php) to prevent shortcode duplication/conflicts with Porto child theme.
...
- **Parents Club Mobile Spacing**:
  ...
  - Added CSS rule `:not(:has(.wpb_wrapper > *))` to `.vc_row` and `.vc_row_inner` in [parents-club-template.css](file:///Users/carlos/Local%20Sites/dev-popularbook/app/public/wp-content/plugins/idl-loader/templates/css/parents-club-template.css) to automatically collapse and hide empty WPBakery rows when inner elements are conditionally hidden by visibility rules.
  - Added mobile media query `(max-width: 768px)` in [parents-club-plan-not-ready.css](file:///Users/carlos/Local%20Sites/dev-popularbook/app/public/wp-content/plugins/idl-loader/templates/css/parents-club-plan-not-ready.css) setting `.pc-plan-not-ready` `margin-bottom: 20px !important;`.
  - Added mobile media query `(max-width: 768px)` in [parents-club-plan-annual.css](file:///Users/carlos/Local%20Sites/dev-popularbook/app/public/wp-content/plugins/idl-loader/templates/css/parents-club-plan-annual.css) setting `.pc-plan-annual` `margin-top: 10px !important;`.
...
- **Form Styling**:
  ...
  - Added CSS rule targeting `.ur-field-item:has(+ .user-registration-password-strength)` to set `margin-bottom: -5px !important` when the strength meter is displayed after the field.
...
- **WPBakery Elements**:
  ...
  - Removed the "Student: [names]" label display line after the total balance in the AI Coins Balance card (`[parents_club_member_coins]`) shortcode handler.
...
- **WPBakery Elements**:
  ...
  - Enhanced the Parents Club AI Coins Card (`[parents_club_member_coins]`) element to query and calculate the **Total Balance** (combining all student-allocated balances and parent-level unallocated balance). Calculated the parent-level unallocated balance locally by subtracting the sum of allocated student credits (via API #11) from the total coins purchased via WooCommerce orders. Added a toggleable "See details" breakdown panel listing student coin balances and unallocated coins.
- **Webhook Integration**:
...
- **WPBakery Elements**:
  ...
  - Added active WooCommerce subscription visibility gating to the eMathSmart Plan Card (`[emathsmart_plan_card]`) and eMathSmart Subscription Product Card (`[emathsmart_subscription_product_card]`) elements so they are hidden for active subscribers.
...
- **WPBakery Elements**:
  ...
  - Added child name indicators to both the Member Subscription Card (`[parents_club_member_subscription]`) and the AI Coins Balance Card (`[parents_club_member_coins]`). The Access details row now appends the child's name in parentheses (e.g. `Grade 3 (Child test1)`), and the AI Coins Balance Card displays a dedicated `Child: [Name]` indicator that updates dynamically on active subscription switches.
- **WPBakery Element Styles**:
...
- **WPBakery Element Styles**:
  - Added `height: stretch;` to `.benefits-column .benefits-glance-card` in [parents-club-hero-benefits.css](file:///Users/carlos/Local%20Sites/dev-popularbook/app/public/wp-content/plugins/idl-loader/templates/css/parents-club-hero-benefits.css).
  ...
  - Wrapped the eMathSmart logo and active status pill inside a new `.sub-logo-group` flexbox container in [parents-club_member.html](file:///Users/carlos/Local%20Sites/dev-popularbook/app/public/wp-content/plugins/idl-loader/templates/parents-club_member.html) and [functions-wpbakery-elements.php](file:///Users/carlos/Local%20Sites/dev-popularbook/app/public/wp-content/plugins/idl-loader/functions-wpbakery-elements.php), declaring its layout styles in [parents-club-dashboard-subscription.css](file:///Users/carlos/Local%20Sites/dev-popularbook/app/public/wp-content/plugins/idl-loader/templates/css/parents-club-dashboard-subscription.css).
  - Restructured the dashboard subscription header in [parents-club_member.html](file:///Users/carlos/Local%20Sites/dev-popularbook/app/public/wp-content/plugins/idl-loader/templates/parents-club_member.html) and [functions-wpbakery-elements.php](file:///Users/carlos/Local%20Sites/dev-popularbook/app/public/wp-content/plugins/idl-loader/functions-wpbakery-elements.php) by placing the `.sub-title` element inside `.sub-logo-group` and nesting the logo and active pill in a new `.sub-logo-badge` container styled in [parents-club-dashboard-subscription.css](file:///Users/carlos/Local%20Sites/dev-popularbook/app/public/wp-content/plugins/idl-loader/templates/css/parents-club-dashboard-subscription.css).
  - Commented out `display: flex`, `align-items`, and `gap` rules for `#parents-club-dashboard .sub-logo-group` in [parents-club-dashboard-subscription.css](file:///Users/carlos/Local%20Sites/dev-popularbook/app/public/wp-content/plugins/idl-loader/templates/css/parents-club-dashboard-subscription.css) per style adjustment request.
  - Added mobile responsive override styles for `#parents-club-dashboard .sub-top` (set to `flex-direction: column !important`, `padding-left: 0 !important`, and `margin-bottom: 25px`) and `#parents-club-dashboard .sub-title` (set to `padding-left: 0 !important`) under the `(max-width: 900px)` media query in [parents-club-dashboard-subscription.css](file:///Users/carlos/Local%20Sites/dev-popularbook/app/public/wp-content/plugins/idl-loader/templates/css/parents-club-dashboard-subscription.css).

  - Added mobile responsive override style for `#parents-club-dashboard .go-btn` (set to `margin-left: 0 !important`) under the `(max-width: 900px)` media query in [parents-club-dashboard-subscription.css](file:///Users/carlos/Local%20Sites/dev-popularbook/app/public/wp-content/plugins/idl-loader/templates/css/parents-club-dashboard-subscription.css).
  - Added mobile responsive override styles for `#parents-club-dashboard .illu` (absolute positioning, low opacity background blend, and `max-width: 100% !important`) and `#parents-club-dashboard .sub-card` (relative positioning, z-index: 1, and `margin-bottom: 20px`) under the `(max-width: 900px)` media query in [parents-club-dashboard-subscription.css](file:///Users/carlos/Local%20Sites/dev-popularbook/app/public/wp-content/plugins/idl-loader/templates/css/parents-club-dashboard-subscription.css).
  - Added mobile responsive override styles for `#parents-club-dashboard .actions` (vertical column layout, gap: 16px, padding-top: 28px) under the `(max-width: 900px)` media query in [parents-club-dashboard-subscription.css](file:///Users/carlos/Local%20Sites/dev-popularbook/app/public/wp-content/plugins/idl-loader/templates/css/parents-club-dashboard-subscription.css).
  ...
  - Updated `.cta-banner-content-col` to align content using `justify-content: flex-start` with a `gap: 90px`, and set `.cta-banner-text` flex property to `none` in [parents-club-cta-banner.css](file:///Users/carlos/Local%20Sites/dev-popularbook/app/public/wp-content/plugins/idl-loader/templates/css/parents-club-cta-banner.css).
  - Updated CTA banner typography: commented out `font-family` from `.cta-banner-text h2` and `.cta-banner-text p`, changed `h2` font-size to `22px` and font-weight to `400`, and changed `p` font-size to `14px` in [parents-club-cta-banner.css](file:///Users/carlos/Local%20Sites/dev-popularbook/app/public/wp-content/plugins/idl-loader/templates/css/parents-club-cta-banner.css).
  - Removed all `font-family` property rules across all WPBakery element stylesheet CSS files in [templates/css/](file:///Users/carlos/Local%20Sites/dev-popularbook/app/public/wp-content/plugins/idl-loader/templates/css/) to allow clean theme typography inheritance.
...
- **WPBakery Element Styles**:
  ...
  - Added `max-height: 40px` to `.brand-column .brand-actions` in [parents-club-hero-brand.css](file:///Users/carlos/Local%20Sites/dev-popularbook/app/public/wp-content/plugins/idl-loader/templates/css/parents-club-hero-brand.css) to constrain the actions container height.
...
### Changed
- **eMathSmart Billing Card Styles**:
  - Updated `#parents-club-dashboard .download-btn` padding to `3px 10px !important` (was `14px 10px !important`) in [parents-club-dashboard-billing.css](file:///Users/carlos/Local%20Sites/dev-popularbook/app/public/wp-content/plugins/idl-loader/templates/css/parents-club-dashboard-billing.css).

## [2026-06-10] - Update Billing Row CSS Padding

### Changed
- **eMathSmart Billing Card Styles**:
  - Updated `#parents-club-dashboard .bill-row` padding to `2px 0px 2px !important` (was `8px 2px !important`) in [parents-club-dashboard-billing.css](file:///Users/carlos/Local%20Sites/dev-popularbook/app/public/wp-content/plugins/idl-loader/templates/css/parents-club-dashboard-billing.css).

## [2026-06-10] - Update Billing Card CSS Padding

### Changed
- **eMathSmart Billing Card Styles**:
  - Updated `#parents-club-dashboard .bill-card` padding to `15px !important` (was `20px 24px !important`) in [parents-club-dashboard-billing.css](file:///Users/carlos/Local%20Sites/dev-popularbook/app/public/wp-content/plugins/idl-loader/templates/css/parents-club-dashboard-billing.css).
...
- **eMathSmart AI Coins Card Styles**:
  ...
  - Added `padding-left: 45px !important` and set margin to `12px 0 2px !important` to `#parents-club-dashboard .coin-row` in [parents-club-dashboard-coins.css](file:///Users/carlos/Local%20Sites/dev-popularbook/app/public/wp-content/plugins/idl-loader/templates/css/parents-club-dashboard-coins.css).
  ...
  - Updated `.coins-desc`: set color to `#33240E !important`, max-width to `270px !important`, margin-bottom to `10px !important`, font-weight to `400 !important`, font-size to `12px !important`, and added `padding-left: 45px !important` in [parents-club-dashboard-coins.css](file:///Users/carlos/Local%20Sites/dev-popularbook/app/public/wp-content/plugins/idl-loader/templates/css/parents-club-dashboard-coins.css).
  ...
  - Updated `.coin-opt .price`: set font-weight to `600 !important`, font-size to `22px !important`, and margin to `0px 0 4px !important` in [parents-club-dashboard-coins.css](file:///Users/carlos/Local%20Sites/dev-popularbook/app/public/wp-content/plugins/idl-loader/templates/css/parents-club-dashboard-coins.css).
  - Updated `.buy-btn`: set width to `fit-content !important`, font-size to `11px !important`, padding to `5px 15px !important`, border-radius to `6px !important`, line-height to `1 !important`, margin-inline to `auto !important`, and removed `font-family` and `font-weight` properties in [parents-club-dashboard-coins.css](file:///Users/carlos/Local%20Sites/dev-popularbook/app/public/wp-content/plugins/idl-loader/templates/css/parents-club-dashboard-coins.css).
...
- **Member Dashboard & Account Overview Layout Backgrounds**:
  ...
  - Added a matching `1px solid #e9ebef` border to both the `.card.coins-card` and `.card.bill-card` components.
